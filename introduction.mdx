---
title: "Powerlevel10k: A Fast, Flexible Zsh Theme With 60+ Segments"
sidebarTitle: "Introduction"
description: "Powerlevel10k is a Zsh theme emphasizing speed, flexibility, and an out-of-the-box experience with 60+ prompt segments and a guided wizard."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Transient Prompt" icon="arrow-turn-down" href="/features/transient-prompt">
  ...
  <Card title="Show on Command" icon="eye" href="/features/show-on-command">
  ...
  <Card title="Powerlevel9k Compatibility" icon="plug" href="/compatibility/powerlevel9k">
  ...
  <Card title="Pure Compatibility" icon="equals" href="/configuration/wizard">
  ...
  <Card title="60+ Built-in Segments" icon="table-cells" href="/reference/all-segments">
  ...
  <Card title="Custom Segment API" icon="code" href="/configuration/custom-segments">
  ...
  <Card title="Smart Directory Truncation" icon="folder-tree" href="/features/directory-truncation">
  ...
  <Card title="Async Git Status" icon="code-branch" href="/features/git-status">
