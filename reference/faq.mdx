---
title: "Powerlevel10k Frequently Asked Questions"
sidebarTitle: "FAQ"
description: "Answers to common questions about Powerlevel10k: performance, git status, colors, plugin managers, Powerlevel9k, and more."
---
...
Zsh 5.3 or newer should work. Instant prompt requires Zsh >= 5.4. It is safe to enable instant prompt even on older versions — it simply has no effect.
</Accordion>
