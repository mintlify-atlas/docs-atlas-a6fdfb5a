---
title: "p10k Command Reference"
sidebarTitle: "p10k Command"
description: "Complete reference for the p10k CLI command — subcommands configure, reload, segment, display, help, finalize, and clear-instant-prompt."
---
...
<ParamField body="POWERLEVEL9K_CONFIG_FILE" type="string" default="~/.p10k.zsh">
  Path to the configuration file written by `p10k configure`. Override this to use a different location.
</ParamField>
