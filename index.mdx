---
title: "Powerlevel10k: The Fastest Zsh Theme"
sidebarTitle: "Home"
description: "Powerlevel10k is a blazing-fast, highly customizable Zsh theme with instant prompt, 60+ built-in segments, and a guided configuration wizard."
---
...
<Note>
  Powerlevel10k is in limited-support mode. The codebase is stable and production-ready, but new features and bug fixes are not actively being developed. See the [GitHub repository](https://github.com/romkatv/powerlevel10k) for details.
</Note>
