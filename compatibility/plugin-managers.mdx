---
title: "Using Powerlevel10k with Zsh Plugin Managers"
sidebarTitle: "Plugin Managers"
description: "Troubleshoot and configure Powerlevel10k with Oh My Zsh, Prezto, Zim, Zinit, Antigen, and other popular Zsh plugin managers."
---
...
<Tabs>
  ...
  <Tab title="Standalone Managers">
    ...
    <Note>
      The `depth=1` ice is optional but recommended for faster cloning. Other ice types are neither recommended nor officially supported by Powerlevel10k.
    </Note>
    ...
    <Note>
      The `depth=1` ice is optional but recommended. Other ice types are neither recommended nor officially supported by Powerlevel10k.
    </Note>
