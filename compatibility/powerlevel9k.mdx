---
title: "Migrate from Powerlevel9k to Powerlevel10k"
sidebarTitle: "Powerlevel9k"
description: "Powerlevel10k is a drop-in replacement for Powerlevel9k — all POWERLEVEL9K_* configuration parameters work unchanged, with dramatically better performance."
---
...
Powerlevel10k does not support the `POWERLEVEL9K_VCS_SHOW_SUBMODULE_DIRTY=true` parameter. If you have this set in your config, remove it to avoid unexpected behavior.

### `POWERLEVEL9K_MODE` Behavior

Powerlevel9k silently ignores `POWERLEVEL9K_MODE` when it is set before the theme is sourced. Powerlevel10k respects it in all cases. If you see different icons in Powerlevel10k compared to Powerlevel9k, you likely have `POWERLEVEL9K_MODE` defined in `~/.zshrc`. Remove that parameter to restore the icon appearance you had with Powerlevel9k.
